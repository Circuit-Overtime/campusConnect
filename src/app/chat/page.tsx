    ...
    return (
        <Card className="h-[calc(100vh-12rem)] flex overflow-hidden">
            ...
            <div className="w-full md:w-2/3 lg:w-3/4 flex flex-col">
                ...
                <div className="flex-grow p-6 overflow-y-auto bg-secondary/30 space-y-4">
                    {currentMessages.map(msg => (
                        <div key={msg.id} className={cn("flex items-end gap-2", msg.sender === 'me' && 'justify-end')}>
                             {msg.sender === 'other' && <Avatar className="h-8 w-8"><AvatarImage src={activeChat.avatar} data-ai-hint="person face"/><AvatarFallback>{activeChat.name.charAt(0)}</AvatarFallback></Avatar>}
                            <div className={cn(
